              ...
              >
                <Td colSpan={1} className="flex flex-1 gap-x-4 p-3">
                  <img
                    ...
                    className="md:h-37 md:w-55 aspect-video rounded-lg object-cover"
                  />
                  <div className="flex flex-col gap-1 justify-between">
                    ...
                    {course.status === COURSE_STATUS.DRAFT ? (
                      <p className="flex w-fit flex-row items-center gap-2 rounded-full bg-richblack-700 px-2 py-0.5 text-[12px] font-medium text-pink-100 uppercase tracking-wider">
                        <HiClock size={14} />
                        Drafted
                      </p>
                    ) : (
                      <p className="flex w-fit flex-row items-center gap-2 rounded-full bg-richblack-700 px-2 py-0.5 text-[12px] font-medium text-yellow-100 uppercase tracking-wider">
