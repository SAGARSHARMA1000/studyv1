...
//             </div>
//             <p className="mt-2 max-w-50 text-center text-xs text-richblack-200 uppercase tracking-wider">
      ...
      >
        ...
        {previewSource ? (
          ...
          <div className="flex flex-col items-center p-6">
            ...
            <ul className="mt-10 flex list-disc justify-between space-x-12 text-xs text-richblack-200 uppercase tracking-wider">
              <li>Aspect ratio 16:9</li>
