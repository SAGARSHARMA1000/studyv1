    ...
    >
      <div className="flex w-11/12 max-w-maxContent items-center justify-between">
                ...
                {link.title === "Catalog" ? (
                  <>
                    ...
                    >
                      ...
                      <BsChevronDown />
                      <div className="invisible absolute left-[50%] top-[50%] z-1000 flex w-50 translate-x-[-50%] translate-y-[3em] flex-col rounded-lg bg-richblack-5 p-4 text-richblack-900 opacity-0 transition-all duration-150 group-hover:visible group-hover:translate-y-[1.65em] group-hover:opacity-100 lg:w-75">
        ...
        <div className="hidden items-center gap-x-4 md:flex">
          ...
          {token === null && (
            <Link to="/login">
              <button className="rounded-lg border border-richblack-700 bg-richblack-800 px-3 py-2 text-richblack-100 uppercase">
                Log In
              </button>
            </Link>
          )}
        ...
        <div className="mr-4 md:hidden">
          ...
          >
            <div className="flex flex-col gap-y-2 py-5 px-5">
              ...
              {/* General Buttons */}
            <div className="h-px my-2 bg-richblack-100 w-3/4 mx-auto"></div>
              ...
              >
                <details>
                  <summary className="flex gap-x-2 items-center w-full py-2 px-3 text-richblack-100 uppercase tracking-wider">
                    ...
                    Category
                    {categoryOpen ? (
                      <SlArrowUp className="translate-y-px ml-auto mr-1" />
                    ) : (
                      <SlArrowDown className="translate-y-px ml-auto mr-1" />
                    )}
                  </summary>
